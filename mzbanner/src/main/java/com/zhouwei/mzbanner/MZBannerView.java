...
public class MZBannerView<T> extends RelativeLayout {
	...
	private int mCurrentItemIndex = 0;//具体位置 1
	private boolean isBannerPlay=false;
	...
	/**
	  滑动的时候是否开启轮播
	 */
	public void setBannerPlay(boolean bannerPlay){
		isBannerPlay=bannerPlay;
	}
	
	/**
	 设置viewpager显示具体的下标 mIsCanLoop必须为false,否则会自动轮播
	 */
	public void setViewPagerCur(int index){
    ...
    public void setPages(List<T> datas,MZHolderCreator mzHolderCreator){
        ...
        mAdapter = new MZPagerAdapter(datas,mzHolderCreator,mIsCanLoop,mCurrentItemIndex);
    ...
    public static class  MZPagerAdapter<T> extends PagerAdapter{
        ...
        public MZPagerAdapter(List<T> datas, MZHolderCreator MZHolderCreator,boolean canLoop,int currentItemIndex) {
            if(mDatas == null){
        ...
        public void setUpViewViewPager(ViewPager viewPager){
            ...
            if(canLoop){
	            ...
	            //int currentItem = mCurrentItemIndex>0 ? getStartSelectItem():0;
	            //设置当前选中的Item
